...
function setupMain(){
    ...
    (function () {
        const phrases = [ 
            ...
            "☄️ By [Niximkk/KhanCheetus](https://github.com/Ryumargin/KhanCheetus/).",
    ...
    (function () {
        ...
        khanwareDominates = true; // Keep this variable name as it's internal to the function
...
.then(async () => {    
    sendToast("🪶 KhanCheetus Minimal injetado com sucesso!");
