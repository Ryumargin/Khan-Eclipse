...
// Nome "Khan Cheetus" com animação RGB e sem efeito laranja
watermark.innerHTML = `
    <span id="khanCheetusName" style="font-weight: 600;">Khan Cheetus</span> 
...
Object.assign(dropdownMenu.style, {
    ...
    boxShadow: '0px 0px 20px rgba(0, 255, 255, 0.3), 0px 0px 10px rgba(255, 0, 255, 0.3)' 
});
...
dropdownMenu.innerHTML = `
    <style>
        ...
        @keyframes rgbColorShift {
            ...
            25% { color: rgb(150, 255, 150); }
            50% { color: rgb(255, 150, 255); }
            75% { color: rgb(255, 200, 100); }
            100% { color: rgb(100, 200, 255); }
        }
        #khanCheetusName {
            animation: rgbColorShift 6s infinite linear;
        }
