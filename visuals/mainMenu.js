...
watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 #ffa500, -2px 0px 0 #ffa500;">KhanCheetus</span> <span style="color:gray; padding-left:2px; font-family: Arial, sans-serif; font-size:10px">${ver}</span>`; // Changed KW to KC
...
dropdownMenu.innerHTML = `
    <style>
        ...
        input[type="checkbox"]:checked {background-color: #ffa500; border-color: #ffa500;}
